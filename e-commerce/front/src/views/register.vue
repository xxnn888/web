    ...
    <div style="width: 100%; height: 100vh; overflow: hidden" class="bgImg">
      <div style="width: 500px; height: 420px; background-color:rgba(9, 50, 113 ,0.2); border-radius: 10px;
        ...
        <div style="width: 260px; margin: 0 auto; padding-top: 30px">
          ...
          <div class="item">
            <input type="text" v-model="user.username" style="width: 100%; padding: 10px; border-radius: 5px;"
                   placeholder="请输入用户名">
          </div>
          <div class="item">
            <input v-model="user.phone" style="width: 100%; padding: 10px; border-radius: 5px; box-sizing:border-box;"
                   placeholder="请输入手机号">
          </div>
          <div class="item">
            <input type="password" v-model="user.password"
                   style="width: 100%; padding: 10px; border-radius: 5px; box-sizing:border-box;" placeholder="请输入密码">
          </div>
          <div class="item">
            <input type="password" v-model="user.confirm"
                   style="width: 100%; padding: 10px; border-radius: 5px; box-sizing:border-box;" placeholder="请确认密码">
          </div>
          <div class="item">
            <button
