    ...
    <el-table :data="tableData" stripe style="width: 100%">
      <el-table-column label="商品图片">
        <template slot-scope="scope">
          <a :href="['/goods?id=' + scope.row.goods.id]">
      ...
      <el-table-column prop="count" label="购买数量">
        <template slot-scope="scope">
          <el-input-number v-model="scope.row.count" :min="1" :max="10" label="购买数量" style="width: 120px"
                           @change="changeCount(scope.row)"></el-input-number>
        </template>
      </el-table-column>
