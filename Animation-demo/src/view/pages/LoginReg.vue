      ...
      <div :class="['dowebok',css2]">
        <div class="form-container sign-up-container">
          <div>
            ...
            <input type="password" v-model="Regster.password" placeholder="以字母开头只能包含字母、数字和下划线">
            <input type="password" v-model="Regster.password2" placeholder="确认密码">
        ...
        <div class="form-container sign-in-container">
          <div>
            <h1>登录</h1>
            <span>或使用您的帐号</span>
            <input type="text" placeholder="账号" v-model="LoginForm.user">
